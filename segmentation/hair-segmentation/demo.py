...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for i, img_path in enumerate(img_paths, 1):
            ...
            img, deprecated_mask = test_joint_transforms(img, deprecated_mask)
            ...
            print(type(logit.cpu().data.numpy()))
            print(logit.cpu().data.numpy())
            ...
            mask_copy = mask * 255
            path = os.path.join(save_dir, os.path.basename(img_path + "_pred_hair_" + str(mask_thres)) +'.png')
